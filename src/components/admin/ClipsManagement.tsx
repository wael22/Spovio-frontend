...
const ClipsManagement: React.FC = () => {
    ...
    const getStatusBadge = (status?: string) => {
        const statuses = {
            ...
            processing: { color: 'bg-blue-100 text-blue-800 border-blue-200 animate-pulse', label: 'En cours...' },
            uploading: { color: 'bg-indigo-100 text-indigo-800 border-indigo-200 animate-pulse', label: 'Téléchargement...' },
            completed: { color: 'bg-green-100 text-green-800 border-green-200', label: 'Prêt' },
            failed: { color: 'bg-red-100 text-red-800 border-red-200', label: 'Échec' }
        };

        const current = statuses[status as keyof typeof statuses] || { color: 'bg-gray-100 text-gray-800 border-gray-200', label: status || 'Inconnu' };
                ...
                <CardContent>
                    {loading ? (
                        ...
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-600">Les clips créés par les utilisateurs apparaîtront ici.</p>
                        </div>
                    ) : (
                        <Table>
                            <TableHeader>
                                ...
                                {clips.map((clip, index) => (
                                    <TableRow key={clip.id}>
                                        ...
                                        <TableCell className="font-medium">
                                            {clip.title}
                                            {clip.description && (
                                                <div className="text-xs text-gray-500 font-normal mt-1 max-w-[200px] truncate">
                                                    {clip.description}
                                                </div>
                                            )}
                                        </TableCell>
                                                ...
                                                <DropdownMenuContent align="end" className="w-64">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <div className="text-xs text-red-500">Suppression de la DB + CDN</div>
                                                        </div>
                                                    </DropdownMenuItem>
                                                </DropdownMenuContent>
                                            </DropdownMenu>
